...
| Audio | Both internal speakers hardware-validated | Revision `r32` drives QUAT MI2S at the stock S24_LE/3.072 MHz contract and safely enables both TFA9874 amplifiers only after clock lock. Separate synchronized webcam-microphone captures measure the upper slot-0 speaker on the left PCM channel and the lower slot-1 speaker on the right PCM channel; both return to power-down after playback. UCM routing, normal volume policy, headphones, earpiece, microphones, headset detection, protection telemetry, and longer thermal validation remain open. |
