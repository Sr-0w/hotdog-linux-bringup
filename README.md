...
| Persistent direct mainline | Upper initcall levels under diagnosis | D36 reaches the checkpoint after level 3 (`arch`), proving levels 0-3 return. D37 bisects the remaining interval after level 5 (`fs`). |
