...
| Persistent direct mainline | General initcalls under diagnosis | D35 reaches the checkpoint immediately before `do_initcalls()`, proving the driver-core preamble returns. D36 bisects the eight general initcall levels after level 3 (`arch`). |
