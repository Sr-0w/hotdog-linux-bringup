...
invariants. A fresh current-pmaports tree now assembles that package through
the normal device flow into a complete initramfs, header-v2 Android boot image,
...
The current package-to-image milestone can be reproduced from the pinned
