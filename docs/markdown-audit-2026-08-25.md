...
| `docs/evidence/2026-08-27-displayport-audio-the-sink-was-started-before-it-listened.md` | Evidence | Historical evidence; dated observations preserved |
...
| `docs/release-notes-v0.2.0-alpha.2.md` | Release record | Immutable description of its exact release |
