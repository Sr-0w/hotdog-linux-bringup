...
## Etat essais boot au 2026-07-10 01:50
...
| lineage414 simplefb ranges command-shell 014400 | prepare, prochain test | Image SHA256 `f99529e3e626b44734e58bc16cb8df7fcbf5efbc76e144c27f19b43d5ea5cd3b`; initramfs SHA256 `899403669fdf5e9a42c8997cc648c66a4c7af9a67cd42bfb47611706e964a240`; base `215005`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; helper DRM SHA256 `302fa020286d2c7941ad1d26c9d4d2ce775dad15665b49b56bdfde6f2b4b6b5b`; ajoute `ranges;` sous `/chosen` pour entry12, `--fb-test`, `--drm-console-userspace`, remplace la boucle initramfs `dmesg` par un prompt `initramfs#` utilisable via FIFO, et garde un follower `dmesg` toutes les 5s pour debug visuel sans USB. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `014400` teste ce correctif sans changer le kernel, laisse un prompt initramfs utilisable via FIFO, et garde un follower `dmesg` visible toutes les 5s.
