...
## Etat essais boot au 2026-07-10 06:10
...
| lineage414 r3 fbdev console ACM retry visible tty 061200 | prepare, prochain test | Image SHA256 `61677f02032308de88b5a08c64c0f3705d9b56c5c45481d5a2616a182991aa27`; kernel pmaports `r3` SHA256 `8d542f8837950e20ecc17681c330c65303cb35e35345afe7e6a30cfc146c5df1`; initramfs SHA256 `84873c5fe7dfb3b420d9a389db31e47ea0e7d9720c4f6abbe5168f314c3abfbf`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; ajoute backend fbdev direct dans `hotdog-drm-console`, lance un rendu PSF dmesg/status sur `/dev/fb0` depuis initramfs, garde USB ACM `ttyGS0` avec bind/retry UDC pendant 120s, direct telnet si NCM fonctionne, rootfs visible tty autocycle, watchdog succes root. |
| lineage414 pmaports kernel rootfs USB watchdog prompt 052210 | prepare, depasse | Image SHA256 `95293d7914633a1368ab54bbdd6f5c36323523c331027262506af189448fde2b`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `cab3233877b8f262330096f05cd41ca978d5a0bacf4e051f0caf7d03a8a84af9`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `051407`, ajoute pid/rearm du watchdog initramfs apres le `killall sh` pmOS et installe un watchdog USB rootfs `local.d` pour garder le retour automatique apres `switch_root`; supersede par `060600`, qui utilise kernel r3 USB ACM et rendu fbdev direct. |
| lineage414 pmaports kernel tty-stop rootfs prompt 051407 USB-if watchdog | prepare, depasse | Image SHA256 `dd4474651c6a2cad96e8a4b07d08a0695a72f50f0d29683c8024c307d20068aa`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `c2a54c47d5ef535ef5ca4a10af6e6f55ba029602ee2e2a8196e59965703a55a4`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `050008`, mais enregistre/stoppe le follower tty kmsg initramfs avant `switch_root` et desactive l'auto-cycle rootfs pour laisser un prompt `screen#` lisible avec status toutes les 20s; supersede par `052210`, qui garde aussi le watchdog USB apres le handoff rootfs. |
| lineage414 pmaports kernel tty autocycle 050008 USB-if watchdog diag | prepare, depasse | Image SHA256 `b6ce8dfc5787f08792a18ec41762bf14ed3152ba1a298f871c7f38eb64a28c99`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `ea92f80d49e00ad6578fa67a790bd032a772775eb0e46c2d7bcc3fb06c931c53`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `045402` mais limite le succes watchdog USB aux interfaces probables de gadget `usb*`, `rndis*`, `enx*`; `eth*` generique ne suffit plus; supersede par `051407`, car le follower tty initramfs pouvait masquer le prompt rootfs. |
| lineage414 pmaports kernel tty autocycle 045402 USB watchdog diag | prepare, depasse | Image SHA256 `a77ed60d92ed55632842aa5a2b0e8f09dfb04bcfcbf63427f3f1f5530ef629c2`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `98c017fc497a6eaa1bbbda377e8e0d6d752600c550a5bf7e3d182efdeaefffa8`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `044715` et ajoute un bloc ecran `usb/watchdog` qui affiche `carrier`, `operstate`, adresse d'interface et marqueurs watchdog dans les pages auto-cycle; supersede par `050008` pour eviter un faux succes via `eth*` generique. |
| lineage414 pmaports kernel tty autocycle 044715 USB carrier watchdog | prepare, depasse | Image SHA256 `c7e0eba401c5a26a66901461fe62f6a8f05895fdd395d3b83c0603267e0b2027`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `edb548fad324da0d8f8a3ddf3beb6522f2b2cce4bf2480e86e3106f64197a494`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `045000` mais durcit le succes watchdog USB: une interface USB reseau doit avoir `carrier=1` ou `operstate=up`; un gadget/UDC configure ne suffit plus; supersede par `045402` pour rendre ce statut visible a l'ecran. |
| lineage414 pmaports kernel tty autocycle 045000 strict USB watchdog | prepare, depasse | Image SHA256 `ab9339224e4b1075ebf78a6ea8fc51084fe8261bc04e7b9f2da51ce568ca70bb`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `29050216ec87e5b24df63077cef57a99fe9afa6ac5e19519c6a4f168cd21c315`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `042500` et ajoute une rotation automatique de pages visibles rootfs toutes les 12s: full status, network/display, puis dmesg; supersede par `044715`, car un gadget/UDC configure pouvait encore arreter le watchdog sans USB visible cote host. |
| lineage414 pmaports kernel tty-kmsg button shell 042500 strict USB watchdog | prepare, depasse | Image SHA256 `cd51f8d5e3cbbf4a984c119f69ee1c3040db1213d69607ab591579fdea2744df`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `ea268033a4804b919370c16664b5eaa6ad3b81cdb252a48944a2c718ae0eb826`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `034500` mais corrige le mode watchdog USB: root/switch-root seuls ne suffisent plus, un UDC nu ne suffit plus, et le timeout tente sysrq reboot avant `reboot -f`; supersede par `045000` pour avoir un retour ecran autonome meme sans boutons/USB. |
| lineage414 pmaports kernel tty-kmsg button shell 034500 | prepare, depasse | Image SHA256 `a0d75bddc547285c5a48606e9682422433bfaaa58104c846662b749f412b5949`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `bea1712b01f4ed53693beb75380af86315c3932097e88170544341b3b09005b1`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; garde le chemin `033600`, force `loglevel=8` en conservant `fbcon=map:0`, `fbcon=font:VGA8x16`, `fbcon=vc:1-1`, et rend le `hotdog-visible-tty-shell` rootfs pilotable aux boutons; supersede par `042500`, `045000`, `044715`, `045402`, puis `050008`, pour garder un meilleur retour autonome si rootfs boote sans USB. |
| lineage414 pmaports kernel tty-kmsg fbprep screen shell 033600 | prepare, depasse | Image SHA256 `8fb34d436fdb7c73a5de5f6fad7cebeb30cc787ca08d3f1117c8fd44e3f69d92`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `b1fb0efa1a9ba246b5304031699d414077d6587ffa29aa54ba5812e680ec124b`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; garde le chemin `030600`, ajoute `--tty-kmsg-console` pour attendre/preparer fb0, booster le backlight et afficher dmesg/status sur tty0/tty1 avant le helper DRM, garde `--visible-tty-shell` apres `switch_root`, et active les args ramoops dans la cmdline; supersede par `034500`. |
| lineage414 pmaports kernel splash tty-kmsg 034200 | prepare, test secondaire | Image SHA256 `51c0d12333407d31a01a3a7f5f3669a23bf5dfe4b9da4b850f2ac3e4c1cc0934`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `cb93effcaa53091bc1266d9cbb5d53b5995f0604910a5174135dca317f9dc4d3`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; garde le chemin `033600` mais ajoute `splash` pour forcer le `setup_framebuffer()` pmOS normal avant Plymouth/splash; wrapper manuel `scripts/test-lineage414-splash-ttykmsg.sh`. |
| lineage414 pmaports kernel screen shell 030600 | prepare, depasse | Image SHA256 `c36b84a0299952569c6a21599a573aff123eee372b3417130f590eef274b91e4`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `e14c04d0e1b2ce580137c1aae6e37382308209e9aa92d5cb6af0a23233a448d7`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; garde le chemin `024200`, ajoute `--visible-tty-shell` pour installer un shell/status follower sur tty1/tty0 apres `switch_root`; supersede par `033600`. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `061200` garde ce DTB pack corrige et le kernel pmaports `r3`, mais teste desormais un rendu texte direct sur `/dev/fb0` pour contourner fbcon si le kernel n'attache pas la console visuelle. Elle garde aussi USB ACM `ttyGS0` avec retry UDC, direct telnet si NCM fonctionne, et un shell/status rootfs `screen#`, tandis que `014400` reste le fallback qui garde le kernel stable.
