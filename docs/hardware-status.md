...
| lineage414 pmaports kernel tty autocycle 045000 strict USB watchdog | prepare, prochain test | Image SHA256 `ab9339224e4b1075ebf78a6ea8fc51084fe8261bc04e7b9f2da51ce568ca70bb`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `29050216ec87e5b24df63077cef57a99fe9afa6ac5e19519c6a4f168cd21c315`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `042500` et ajoute une rotation automatique de pages visibles rootfs toutes les 12s: full status, network/display, puis dmesg, utile si le rootfs boote sans USB ni entree. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `045000` teste ce correctif avec le kernel pmaports configure pour VT/fbcon/simplefb, les diagnostics locaux Vol+/Vol-, un follower tty0/tty1 dmesg/status avec preparation fb0/backlight en initramfs, et un shell/status follower tty1/tty0 apres `switch_root` pilotable aux boutons ou par auto-cycle ecran toutes les 12s, tandis que `014400` reste le fallback qui garde le kernel stable.
