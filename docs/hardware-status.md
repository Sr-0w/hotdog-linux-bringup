...
| lineage414 pmaports kernel tty-kmsg fbprep screen shell 033600 | prepare, prochain test | Image SHA256 `8fb34d436fdb7c73a5de5f6fad7cebeb30cc787ca08d3f1117c8fd44e3f69d92`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `b1fb0efa1a9ba246b5304031699d414077d6587ffa29aa54ba5812e680ec124b`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; garde le chemin `030600`, ajoute `--tty-kmsg-console` pour attendre/preparer fb0, booster le backlight et afficher dmesg/status sur tty0/tty1 avant le helper DRM, garde `--visible-tty-shell` apres `switch_root`, et active les args ramoops dans la cmdline. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `033600` teste ce correctif avec le kernel pmaports configure pour VT/fbcon/simplefb, les diagnostics locaux Vol+/Vol-, un follower tty0/tty1 dmesg/status avec preparation fb0/backlight en initramfs, et un shell/status follower tty1/tty0 apres `switch_root`, tandis que `014400` reste le fallback qui garde le kernel stable.
