...
| lineage414 pmaports kernel tty autocycle 044715 USB carrier watchdog | prepare, prochain test | Image SHA256 `c7e0eba401c5a26a66901461fe62f6a8f05895fdd395d3b83c0603267e0b2027`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `edb548fad324da0d8f8a3ddf3beb6522f2b2cce4bf2480e86e3106f64197a494`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `045000` mais durcit le succes watchdog USB: une interface USB reseau doit avoir `carrier=1` ou `operstate=up`; un gadget/UDC configure ne suffit plus. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `044715` teste ce correctif avec le kernel pmaports configure pour VT/fbcon/simplefb, les diagnostics locaux Vol+/Vol-, un follower tty0/tty1 dmesg/status avec preparation fb0/backlight en initramfs, et un shell/status follower tty1/tty0 apres `switch_root` pilotable aux boutons ou par auto-cycle ecran toutes les 12s, tandis que `014400` reste le fallback qui garde le kernel stable.
