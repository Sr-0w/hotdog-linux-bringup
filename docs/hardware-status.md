...
## Etat essais boot au 2026-07-10 01:55
...
| lineage414 pmaports kernel fbcon 015500 | prepare, prochain test | Image SHA256 `b50b29f7ea2a41e64b3a4bdb78ce2dc848f68915a75ec9d1ed4d7064c9727633`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `d9921ece8fb8b08ec593f16af1f3d9ac3d0410dc2f1511782eff38e7785a0201`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; helper DRM SHA256 `fe8c9beea81e5e19c18affa1fc98252bc4adba81fa4b652df56cc24b9ce500e7`; teste le kernel pmaports avec `VT`, `FB_SIMPLE`, `FRAMEBUFFER_CONSOLE`, `DRM_FBDEV_EMULATION`, plus le fixed DTB pack et le helper DRM auto-diagnostic. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `015500` teste ce correctif avec le kernel pmaports configure pour VT/fbcon/simplefb, tandis que `014400` reste le fallback qui garde le kernel stable.
