...
## Etat essais boot au 2026-07-10 03:45
...
| lineage414 pmaports kernel tty-kmsg button shell 034500 | prepare, prochain test | Image SHA256 `a0d75bddc547285c5a48606e9682422433bfaaa58104c846662b749f412b5949`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `bea1712b01f4ed53693beb75380af86315c3932097e88170544341b3b09005b1`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; garde le chemin `033600`, force `loglevel=8` en conservant `fbcon=map:0`, `fbcon=font:VGA8x16`, `fbcon=vc:1-1`, et rend le `hotdog-visible-tty-shell` rootfs pilotable aux boutons: Vol+ statut complet, Vol- reseau/ecran, Power dmesg. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `034500` teste ce correctif avec le kernel pmaports configure pour VT/fbcon/simplefb, les diagnostics locaux Vol+/Vol-, un follower tty0/tty1 dmesg/status avec preparation fb0/backlight en initramfs, et un shell/status follower tty1/tty0 apres `switch_root` pilotable aux boutons, tandis que `014400` reste le fallback qui garde le kernel stable.
