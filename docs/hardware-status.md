...
| lineage414 pmaports kernel tty autocycle 045402 USB watchdog diag | prepare, prochain test | Image SHA256 `a77ed60d92ed55632842aa5a2b0e8f09dfb04bcfcbf63427f3f1f5530ef629c2`; kernel pmaports `r2` SHA256 `c6411a83cc004d52209b39d9ac6fa552d93b5be719bbaa0536060c78e4d4266e`; initramfs SHA256 `98c017fc497a6eaa1bbbda377e8e0d6d752600c550a5bf7e3d182efdeaefffa8`; DTB pack SHA256 `9ed26b5cc289633ae1b98ce3212a084d673779fb188307a442f4922588032040`; reprend `044715` et ajoute un bloc ecran `usb/watchdog` qui affiche `carrier`, `operstate`, adresse d'interface et marqueurs watchdog dans les pages auto-cycle. |
...
Le `No memory resource` de simple-framebuffer a maintenant une hypothese concrete: le pack multi-DTB entry12 simplefb manquait `ranges;` sous `/chosen`; l'image preparee `045402` teste ce correctif avec le kernel pmaports configure pour VT/fbcon/simplefb, les diagnostics locaux Vol+/Vol-, un follower tty0/tty1 dmesg/status avec preparation fb0/backlight en initramfs, et un shell/status follower tty1/tty0 apres `switch_root` pilotable aux boutons ou par auto-cycle ecran toutes les 12s, tandis que `014400` reste le fallback qui garde le kernel stable.
