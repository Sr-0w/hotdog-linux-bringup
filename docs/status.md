...
| Audio | Lower speaker hardware-validated; upper speaker candidate built | Revision `r31` matches the OxygenOS QUAT MI2S S24_LE format, 3.072 MHz BCLK, and TFA9874 slot profile. A bounded -60 dBFS tone is audible from the lower speaker and produces an independently measured approximately -43 dBFS 1 kHz component at the webcam microphone. Channel isolation maps the lower slot-1 amplifier to the right PCM channel, and every close returns it to power-down. Revision `r32` links the upper slot-0 amplifier and passes the strict build/DTB contract; its physical output remains to be tested. UCM, normal volume policy, protection telemetry, headphones, earpiece, microphones, and headset detection remain open. |
