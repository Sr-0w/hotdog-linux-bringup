...
| Cameras | Three rear cameras working; front sensor identified and bounded motor motion validated | Revisions `r51` through `r90` provide S5K3M5 RAW10 capture, libcamera automatic exposure, calibrated manual focus and Plasma Camera. Revisions `r98` through `r109` add Sony IMX586 C-PHY capture, metadata and autofocus. Revision `r111` adds the physical IMX481 ultra-wide and validates two 180-frame processed runs at 30 fps. Revision `r112` binds the Sony IMX471 front sensor on CCI1 master 0, while `r113` exposes both MXM1120 pop-up Hall sensors through IIO and measures a stable closed baseline of `-13..-14` upper and `-369..-370` lower. The corrected `r115` one-shot preflight emits exactly 320 upward microsteps; hardware changed the lower Hall reading from `-370` to a stable `-364..-365`, validating direction and 1/32 stepping without approaching either endpoint. Device package `3-r17` keeps WirePlumber from owning CAMSS; `3-r18` installs and enables `qbootctl`. Full Hall-terminated travel, front capture/libcamera validation and production color calibration remain open. See the [IMX471 and pop-up evidence](evidence/2026-08-10-mainline616-camera-imx471-popup.md), [IMX481 evidence](evidence/2026-08-10-mainline616-camera-imx481.md), [autofocus evidence](evidence/2026-08-10-mainline616-camera-autofocus.md), [A/B evidence](evidence/2026-08-10-ab-slot-success.md), [IMX586 evidence](evidence/2026-08-09-mainline616-camera-imx586.md), [main focus evidence](evidence/2026-08-10-mainline616-camera-imx586-focus.md), [telephoto capture evidence](evidence/2026-08-09-mainline616-camera-telephoto.md), [telephoto focus evidence](evidence/2026-08-09-mainline616-camera-telephoto-focus.md), [libcamera evidence](evidence/2026-08-09-mainline616-camera-libcamera.md) and [port plan](camera-port-plan.md). |
