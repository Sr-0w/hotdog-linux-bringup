...
| Battery / SMB5 charging | Partial | Fuel gauge works. The upstream-shaped SMB5 v3 candidate passed guarded 180 s and 600 s charge runs, host authorization and a physical VBUS cycle. Termination, low battery, JEITA/thermal, off-mode, fast charge and suspend remain. |
