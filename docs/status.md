...
| Cameras | Telephoto and main capture with libcamera and Plasma Camera | Revisions `r51` through `r90` provide S5K3M5 RAW10 capture, libcamera automatic exposure, calibrated manual focus and Plasma Camera. Revisions `r98` through `r100` add SM8150 three-trio C-PHY transport, the Sony IMX586 driver, native-array geometry and standard orientation/rotation metadata. The main camera produces complete 15,024,000-byte 4000×3000 RAW10 buffers with distinct hashes and no CAMNOC or SMMU error. Libcamera `r3` adds the Sony gain law, OxygenOS two-frame control delays and a simple IPA profile. Revision `r109` selects the physical Semco second-lens IMX586 module, binds its LC898217XC actuator and validates manual focus from 0 through 400. Libcamera `r4` adds independent lens-control plumbing and coarse/fine contrast autofocus; revision `r7` gates scanning on stable AGC requests and hardware-validates continuous autofocus on both rear modules. On a textured desk the telephoto metric rose from 7259 at position 0 to 8878 at 400, selected 400, and a separate manual pair visually confirmed that endpoint as sharp. Device package `3-r17` keeps WirePlumber from owning CAMSS; `3-r18` installs and enables `qbootctl` so successful userspace boots cannot exhaust slot retries. Production color calibration, IMX481/IMX471 and the pop-up motor remain open. See the [autofocus evidence](evidence/2026-08-10-mainline616-camera-autofocus.md), [A/B evidence](evidence/2026-08-10-ab-slot-success.md), [IMX586 evidence](evidence/2026-08-09-mainline616-camera-imx586.md), [main focus evidence](evidence/2026-08-10-mainline616-camera-imx586-focus.md), [telephoto capture evidence](evidence/2026-08-09-mainline616-camera-telephoto.md), [telephoto focus evidence](evidence/2026-08-09-mainline616-camera-telephoto-focus.md), [libcamera evidence](evidence/2026-08-09-mainline616-camera-libcamera.md) and [port plan](camera-port-plan.md). |
