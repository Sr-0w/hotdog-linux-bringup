...
| Audio | Both internal speakers hardware-validated | Revision `r32` matches the OxygenOS QUAT MI2S S24_LE format, 3.072 MHz BCLK, and TFA9874 slot profile. Independent -48 dBFS left/right stimuli produce stable 1 kHz components at approximately -58.9 dBFS from the upper slot-0 speaker and -43.0 dBFS from the lower slot-1 speaker in synchronized webcam-microphone captures. Both codecs lock cleanly and every close returns them to power-down. UCM, normal volume policy, protection telemetry, headphones, earpiece, microphones, and headset detection remain open. |
