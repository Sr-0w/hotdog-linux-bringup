...
| Cameras | Telephoto capture, libcamera AE, Plasma Camera and manual focus working | Revisions `r51` through `r83` add SM8150 CAMSS/CCI, board wiring, the Samsung S5K3M5 driver, CSIPHY 1.1 support and the missing HF AXI bridge. Clean-boot captures produce complete 16,423,680-byte 4208×3120 RAW10 buffers with distinct hashes and no CAMNOC or SMMU error. Revisions `r84` through `r87` identify the Semco LC898217XC actuator at CCI address `0x74`, add its V4L2 driver, and calibrate `focus_absolute` to 0–400; position 400 is visibly sharp while 0 is blurred. Revisions `r88` through `r90` add S5K3M5 libcamera properties, timing delays, helper and tuning data, correct the V4L2 geometry/orientation contract, and package the userspace. A 60-frame run exposes 16 automatic exposure values from 2574 to 6075 us, advertises gain 1–16, and Plasma Camera reaches ready-for-capture with a 4200×3120 viewfinder. Gain stayed at its 1.0 floor in the tested bright scene. Automatic focus, production color calibration, IMX586/IMX481/IMX471 and the pop-up motor remain open. See the [capture evidence](evidence/2026-08-09-mainline616-camera-telephoto.md), [focus evidence](evidence/2026-08-09-mainline616-camera-telephoto-focus.md), [libcamera evidence](evidence/2026-08-09-mainline616-camera-libcamera.md) and [port plan](camera-port-plan.md). |
