...
| `/home/srobin/dev/hotdog/scripts/build-entry12-simplefb-ranges-dtbpack.sh` | Rebuilds the fixed entry12 simplefb `ranges;` DTB pack used by the prepared `014400`, `015500`, `024200`, and `030600` images. |
...
| `/home/srobin/dev/hotdog/scripts/test-next-lineage414-simplefb-shell.sh` | Wrapper for the next `030600` hardware test. It restores `boot_b` to `215005` and starts a companion rescue watcher. |
