...
| `/home/srobin/dev/hotdog/scripts/validate-current-candidates.sh` | Offline validation gate for the current next and secondary boot candidates. It checks wrapper paths, expected cmdline words, entry12 simplefb wiring, and generated helper shell syntax without using phone commands. |
