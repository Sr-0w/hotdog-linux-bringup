...
| D22 | Prepared: reset immediately before `smp_init()` | Separates workqueue, memory, and pre-SMP initcall setup from secondary CPU bring-up and scheduler SMP initialization. |
...
immediately before `smp_init()`. R6 plus
