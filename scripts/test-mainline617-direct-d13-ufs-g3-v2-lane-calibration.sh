...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-31-235633-mainline617-direct-native-ufs-g3-v2-lane-calibration/boot.img"
...
BOOT_SHA=1efe20d49953d32409091db1ef2b461236dd5f88f22fc524cc5b154dc9a6d7d7
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d13-ufs-g3-v2-lane-calibration.sh
