...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-16-013829-mainline617-direct-virtual-flow-fbcheckpoints/boot.img"
...
BOOT_SHA=4236402b872cd9174dc42dbb1cc348d7d214dccbc76a56b8f5b776f74dcbd348
...
early virtual-address transition, an SM8150 system-counter probe performed only
after that watchdog is armed, and a persistent per-initcall breadcrumb. If
Qualcomm 900e appears, the stage and raw counter samples are read automatically.
The verified R6 bridge and stock DTBO remain the rollback target. Set
