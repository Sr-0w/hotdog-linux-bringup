...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-16-002837-mainline617-direct-pre-mmu-fbcheckpoints/boot.img"
...
BOOT_SHA=9c7c62f15fcdd84429f61974d08a3b36228adbf91b0d92901df1f39c116d6374
...
three compact pre-MMU framebuffer checkpoints, an SM8150 system-counter probe
performed only after that watchdog is armed, and a persistent per-initcall
