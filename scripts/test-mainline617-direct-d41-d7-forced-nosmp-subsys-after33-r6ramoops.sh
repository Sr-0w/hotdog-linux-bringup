...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-002100-mainline617-direct-d41-d7-forced-nosmp-subsys-after33-r6ramoops/boot.img"
...
BOOT_SHA=24c4415c29810129dbe8837a52b8a8f6cbdcc9b8a02655c6f4dd7cd812e59be6
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d41-d7-forced-nosmp-subsys-after33-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 33 of 138.
...
check_sha "D41 forced no-SMP subsys-after33 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
