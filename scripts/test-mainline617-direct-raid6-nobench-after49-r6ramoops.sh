...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-083100-mainline617-direct-raid6-nobench-after49-r6ramoops/boot.img"
...
BOOT_SHA=84a695942b0aaec44f7a0a53dea0afc5a4a4ac7432bc9cbc796165883d42ab8d
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-raid6-nobench-after49-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 49 of 138.
Keep RAID6 enabled but disable CONFIG_RAID6_PQ_BENCHMARK.
...
check_sha "RAID6 no-benchmark subsys-after49 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
