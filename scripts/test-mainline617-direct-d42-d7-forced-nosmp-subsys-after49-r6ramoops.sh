...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-064000-mainline617-direct-d42-d7-forced-nosmp-subsys-after49-r6ramoops/boot.img"
...
BOOT_SHA=f5f3fd2f5ed55206f3358bea81dc46a001759b86120baf6ce4e42d7af5a0e87f
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d42-d7-forced-nosmp-subsys-after49-r6ramoops.sh
...
check_sha "D42 forced no-SMP subsys-after49 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
