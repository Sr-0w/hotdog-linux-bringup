...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-073000-mainline617-direct-d47-d7-forced-nosmp-subsys-after45-r6ramoops/boot.img"
...
BOOT_SHA=5a5d22a38a902f09e87143e2c3053ee96de6eef96ff848bad08e0099a15c588a
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d47-d7-forced-nosmp-subsys-after45-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 45 of 138.
...
check_sha "D47 forced no-SMP subsys-after45 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
