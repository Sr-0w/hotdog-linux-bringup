...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-001000-mainline617-direct-d40-d7-forced-nosmp-subsys-after66-r6ramoops/boot.img"
...
BOOT_SHA=9f95119b912c1d56a6fdbd31da0ec2331319ba3de7b0768f83347736d9483400
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d40-d7-forced-nosmp-subsys-after66-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 66 of 138.
...
check_sha "D40 forced no-SMP subsys-after66 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
