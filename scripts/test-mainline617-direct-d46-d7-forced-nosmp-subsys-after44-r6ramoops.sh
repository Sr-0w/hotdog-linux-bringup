...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-072800-mainline617-direct-d46-d7-forced-nosmp-subsys-after44-r6ramoops/boot.img"
...
BOOT_SHA=f2dfb7a70a2ff98fa28969454d5d76487c704f2bff8484607b8e62d154c6e4ee
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d46-d7-forced-nosmp-subsys-after44-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 44 of 138.
...
check_sha "D46 forced no-SMP subsys-after44 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
