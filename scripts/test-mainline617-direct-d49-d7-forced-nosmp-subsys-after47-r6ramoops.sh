...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-080500-mainline617-direct-d49-d7-forced-nosmp-subsys-after47-r6ramoops/boot.img"
...
BOOT_SHA=67133058f7f46f182349796776c6d60ecdc2076ab11dc8c545d4c3db342ed0e7
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d49-d7-forced-nosmp-subsys-after47-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 47 of 138.
...
check_sha "D49 forced no-SMP subsys-after47 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
