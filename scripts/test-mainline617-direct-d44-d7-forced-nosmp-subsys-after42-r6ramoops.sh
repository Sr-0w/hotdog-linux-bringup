...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-070700-mainline617-direct-d44-d7-forced-nosmp-subsys-after42-r6ramoops/boot.img"
...
BOOT_SHA=947a4fce1549c3c821e6415f24ef89e29fa99ceece6befc4dcf21b0063640eac
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d44-d7-forced-nosmp-subsys-after42-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 42 of 138.
...
check_sha "D44 forced no-SMP subsys-after42 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
