...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-075300-mainline617-direct-d48-d7-forced-nosmp-subsys-after46-r6ramoops/boot.img"
...
BOOT_SHA=c6fb06be37984b90d96b734e6dde3ddedbd48fff68b3745556779c87406bccd4
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d48-d7-forced-nosmp-subsys-after46-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 46 of 138.
...
check_sha "D48 forced no-SMP subsys-after46 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
