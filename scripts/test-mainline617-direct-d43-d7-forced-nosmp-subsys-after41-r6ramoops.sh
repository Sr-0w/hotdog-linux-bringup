...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-065100-mainline617-direct-d43-d7-forced-nosmp-subsys-after41-r6ramoops/boot.img"
...
BOOT_SHA=08b6b375213e1fa7fe7bef8e907a8d83d0b146601afae393c046f0ef3ac176a8
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d43-d7-forced-nosmp-subsys-after41-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 41 of 138.
...
check_sha "D43 forced no-SMP subsys-after41 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
