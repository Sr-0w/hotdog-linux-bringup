...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-15-071700-mainline617-direct-d45-d7-forced-nosmp-subsys-after43-r6ramoops/boot.img"
...
BOOT_SHA=c4d527d79b18a30b181e000ce18057f205e14eeb7c34a4dcbb997eac99f59624
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d45-d7-forced-nosmp-subsys-after43-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 43 of 138.
...
check_sha "D45 forced no-SMP subsys-after43 reset image" "$BOOT_IMAGE" "$BOOT_SHA"
