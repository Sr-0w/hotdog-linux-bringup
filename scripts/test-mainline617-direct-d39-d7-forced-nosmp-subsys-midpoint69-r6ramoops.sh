...
BOOT_IMAGE="$HOTDOG_ROOT/images/pmos-experiments/2026-07-13-154000-mainline617-direct-d39-d7-forced-nosmp-subsys-midpoint69-r6ramoops/boot.img"
...
BOOT_SHA=dbe0663e4c766b9e4ed3cbed634eee2ce57480b391f2641a4dbd36a4907a57d0
...
if [ "${1:-}" = -h ] || [ "${1:-}" = --help ]; then
	cat <<'USAGE'
Usage: test-mainline617-direct-d39-d7-forced-nosmp-subsys-midpoint69-r6ramoops.sh

Force setup_max_cpus=0 and reset after subsys initcall 69 of 138.
...
check_sha "D39 forced no-SMP subsys-midpoint reset image" "$BOOT_IMAGE" "$BOOT_SHA"
